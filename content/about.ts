/**
 * Profile of the centre's lead.
 * Prose translated from reference/site/pages/bio.md; education and research
 * interests from reference/site/docs/cv.pdf. Institution names, degree names
 * and journal names are kept in English exactly as published.
 */

export const about = {
  eyebrow: "Về chúng tôi",
  title: "Dr. Cong Tam Trinh",
  subtitle: "Người dẫn dắt chuyên môn của HDI Research Center",
  portrait: {
    src: "/images/portrait.jpg",
    alt: "Chân dung Dr. Cong Tam Trinh",
  },
  paragraphs: [
